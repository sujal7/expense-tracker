            ...
            >
                  ...
                  {(Object.keys(FORMAT_META) as ExportFormat[]).map((fmt) => {
                    ...
                    return (
                      <button
                        ...
                        style={{
                          background: active ? "rgba(240,165,0,0.1)" : "rgba(255,255,255,0.03)",
                          border: active
                      ...
                      >
                        <div className="text-sm font-bold font-mono">{FORMAT_META[fmt].label}</div>
                        <div
                          className="text-xs mt-0.5 font-sans"
                          style={{ color: active ? "rgba(240,165,0,0.55)" : "rgba(255,255,255,0.2)" }}
                        >
              ...
              <section>
                ...
                <div className="grid grid-cols-2 gap-3 mt-3">
                  <DateField label="From" value={startDate} onChange={setStartDate} placeholder="All time" />
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-3 text-xs">
                    <button
                      ...
                      style={{ color: allSelected ? "rgba(255,255,255,0.2)" : "var(--accent)" }}
                    ...
                    <button
                      ...
                      style={{ color: noneSelected ? "rgba(255,255,255,0.2)" : "var(--text-muted)" }}
                  ...
                  {CATEGORIES.map((cat) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        >
                          {checked && (
                            <span style={{ color: "var(--accent)", fontSize: "9px", fontWeight: 800 }}>
                              ✓
                            </span>
                          )}
                        </span>
            ...
            <div className="p-6 flex flex-col gap-5">
              ...
              >
                ...
                {(startDate || endDate !== today || !allSelected) && (
                  <div className="flex flex-wrap gap-1.5 mt-3 pt-3" style={dividerStyle as React.CSSProperties}>
                    {startDate && (
                      <Pill>From {startDate}</Pill>
                    )}
                    {endDate && endDate !== today && (
                      <Pill>To {endDate}</Pill>
                    )}
                    {!allSelected && selectedCategories.size > 0 && (
                      <Pill>{selectedCategories.size} categor{selectedCategories.size === 1 ? "y" : "ies"}</Pill>
                    )}
                    {noneSelected && (
                      <Pill warn>No categories</Pill>
                    )}
                  </div>
                )}
              </div>
                ...
                {filtered.length === 0 ? (
                  ...
                  >
                    ...
                    {overflow > 0 && (
                      ...
                      >
                        ···&nbsp;&nbsp;{overflow} more record{overflow !== 1 ? "s" : ""} not shown
                      </div>
                    )}
                  </div>
                )}
